...
>(({ className, ...props }, ref) => (
    <DialogPrimitive.Title
        ref={ref}
        className={cn(
            "text-lg antialiased font-semibold leading-none tracking-tight font-roboto-mono text-label-primary ",
            className
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <DialogPrimitive.Description
        ref={ref}
        className={cn("text-xs font-roboto-mono text-label-quaternary", className)}
        {...props}
    />
))
