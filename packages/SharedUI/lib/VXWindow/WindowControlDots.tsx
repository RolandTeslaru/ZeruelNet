...
import { Popover, PopoverContent, PopoverItem, PopoverTrigger } from "../foundations/popover"
import { useWindowContext } from "./useWindowContext"
import { useUIManagerAPI } from "../UIManager/store"

export const WindowControlDots = () => {
    const { vxWindowId } = useWindowContext()
    const isAttached = useUIManagerAPI(state => state.vxWindows[vxWindowId].isAttached)
