    ...
    "zeruel_net": {
        ...
        children: {
            ...
            "knowledge_subjects": {
                isExpanded: true,
                children: {
                    "columns": { data: { tableName: "knowledge_subjects" } },
                    "constraints": { data: { tableName: "knowledge_subjects" } },
                    "indexes": { data: { tableName: "knowledge_subjects" } },
                    "triggers": { data: { tableName: "knowledge_subjects" } },
                }
            },
        }
    }
...
const ICON_MAP = {
    ...
    "knowledge_subjects": <svg className='h-4 w-4 stroke-blue-300' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 3H5a2 2 0 0 0-2 2v4m6-6h10a2 2 0 0 1 2 2v4M9 3v18m0 0h10a2 2 0 0 0 2-2V9M9 21H5a2 2 0 0 1-2-2V9m0 0h18" /></svg>,
    ...
    "columns": <svg className='w-4 h-4 text-green-300' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" ><rect width="18" height="18" x="3" y="3" rx="2" /><path d="M12 3v18" /></svg>,
    "indexes": <svg className='w-4 h-4 text-cyan-300' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 12H3" /><path d="M16 18H3" /><path d="M16 6H3" /><path d="M21 12h.01" /><path d="M21 18h.01" /><path d="M21 6h.01" /></svg>,
    "triggers": <svg className='w-4 h-4 text-sky-300' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" ><path d="M4 10a7.31 7.31 0 0 0 10 10Z" /><path d="m9 15 3-3" /><path d="M17 13a6 6 0 0 0-6-6" /><path d="M21 13A10 10 0 0 0 11 3" /></svg>
}
