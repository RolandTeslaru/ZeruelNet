...
export const LogPanel = () => {
    ...
    return (
        <div className="w-full h-full  rounded-lg shadow-inner overflow-hidden">
            <div className="flex ml-2">
                <Server className="!text-white/70 h-4 mt-1" />
                <h3 className="text-md font-normal text-white/50 mb-2 font-nippo">Server Log</h3>
            </div>
            ...
            <Virtuoso
                ...
                itemContent={(index, log) => (
                    <p key={index} className={`!text-[11px] font-mono px-2 ${levelColorMap[log.level] || 'text-gray-400'}`}>
