  ...
  return (
    ...
    >
      ...
      <SliderPrimitive.Thumb
        className="block h-2.5 w-2.5 rounded-full bg-white border-2 border-primary ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
