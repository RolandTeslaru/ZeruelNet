...
import { Box, Brush, Display, Engine, Film, Video } from '../../icons'
import VexrLogo from '../../components/VexrLogo'
import { DialogDescription, DialogTitle, ScrollArea } from '../../foundations'
...
export const DialogSettings = () => {
    ...
    return (
        <div className='flex flex-row h-[600px]'>
            ...
            <SettingsContent selectedElementKey={selectedElementKey as keyof typeof SETTINGS_CONTENT_MAP} />
        </div>
    )
}
    ...
    return (
        <div className='w-[220px] flex flex-col p-2 pb-0 gap-2 bg-tertiary-thin border-r border-neutral-950'>
            <div className='flex flex-col gap-1'>
                <VexrLogo className='h-16 text-white'/>
            ...
            <DialogDescription className='text-center mt-auto text-label-quaternary mb-3'>
                <div className='flex flex-col gap-1'>
...
const SettingsContent = ({ selectedElementKey }: { selectedElementKey: keyof typeof SETTINGS_CONTENT_MAP }) => {
